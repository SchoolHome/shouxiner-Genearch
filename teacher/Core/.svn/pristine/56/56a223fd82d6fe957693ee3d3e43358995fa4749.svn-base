...
@interface CPPTModelPersonalInfoDataAddition : NSObject
{

    NSNumber *id_;//主键
    NSNumber *personalInfoDataID_;//个人数据表主键
    NSNumber *personalInfoID_;//
    NSNumber *dataClassify_;//数据分类，类似memo、头像等等
