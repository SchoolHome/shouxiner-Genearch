//
//  CPOperationMsgReSend.m
//  iCouple
//
//  Created by yong wei on 12-5-26.
//  Copyright (c) 2012年 fanxer. All rights reserved.
//

#import "CPOperationMsgReSend.h"
...
#import "CoreUtils.h"
@implementation CPOperationMsgReSend
                    ...
                    if ([uiMsgGroup.memberList count]>0)
                    {
                        ...
                        switch (msgType)
                        {
                            ...
                            case MSG_CONTENT_TYPE_ALARMED_TEXT:
                                [[[CPSystemEngine sharedInstance] xmppEngine] sendInstantMessage:userMsg];
                                break;
                            case MSG_CONTENT_TYPE_CQ:
                            case MSG_CONTENT_TYPE_CS:
                            case MSG_CONTENT_TYPE_TTW:
