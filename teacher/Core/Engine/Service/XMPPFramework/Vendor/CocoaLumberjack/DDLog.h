...
#define CPLog(frmt, ...)        LOG_OBJC_MAYBE(LOG_ASYNC_VERBOSE, ddLogLevel, LOG_FLAG_VERBOSE, \
                                            0, @"%@: %@ ", THIS_FILE, THIS_METHOD,frmt, ##__VA_ARGS__)

#define CPLogInfo(frmt, ...)       LOG_OBJC_MAYBE(LOG_ASYNC_VERBOSE, ddLogLevel, LOG_FLAG_VERBOSE, 0, (@"%s [Line %d] " frmt),__PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define CPLogWarn(frmt, ...)       LOG_OBJC_MAYBE(LOG_ASYNC_WARN, ddLogLevel, LOG_ASYNC_WARN, 0, (@"%s [Line %d] " frmt),__PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)

#define CPLogError(frmt, ...)      LOG_OBJC_MAYBE(LOG_ASYNC_ERROR, ddLogLevel, LOG_ASYNC_ERROR, 0, (@"%s [Line %d] " frmt),__PRETTY_FUNCTION__, __LINE__, ##__VA_ARGS__)
