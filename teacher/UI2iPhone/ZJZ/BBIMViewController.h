...
@interface BBIMViewController : BBmessageMainViewController <RecentViewDelegate,MessageInforDelegate,MusicPlayerManagerDelegate,PetViewDelegate,UIImagePickerControllerDelegate,CheckMessageDelegate,FXBlockViewSubmitDelegate>
{
