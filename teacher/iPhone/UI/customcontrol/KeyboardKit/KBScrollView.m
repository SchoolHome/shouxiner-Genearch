...
//  Guid_dev
//
//  Created by ming bright on 12-7-2.
...
- (id <KBScrollViewDelegate>)delegate
{
	return (id <KBScrollViewDelegate>) [super delegate];
}

- (void)setDelegate:(id<KBScrollViewDelegate>)delegate
{
